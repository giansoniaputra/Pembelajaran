...
class Produk{
    ...
    public function __construct($judul = "judul", $penulis = "penulis", $penerbit = "penerbit", $harga = "harga", $waktuMain = 0, $jmlHalaman = 0, ) {
        $this->judul = $judul;
...
class Games extends Produk{
    public function getInfoProduk(){
        $str = "Games: {$this->judul} | {$this->getLebel()} (Rp. {$this->harga}) ~ {$this->waktuMain} Jam.";
        return $str;
    }
...
$produk2 = new Games("Mobile Legend", "Moonton","Moonton","250000",0.5,0);
